...
---INFORMATIONS
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- informations = { Author   = Seytz ( github.com/seytz ) 
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
myScratchpads = 
              [ NS "terminal" "urxvt -e "                            (resource =? "terminal") myPosition
              , NS "music" "urxvt  -e ncmpcpp"                       (resource =? "music")    myPosition
              , NS "rtorrent" "urxvt -e rtorrent "                   (resource =? "rtorrent") myPosition
              , NS "wcalc" "urxvt -e wcalc -e wcalc"                 (resource =? "wcalc")    myPosition
...
myKeys =
    ...
    -- Apps
        ...
        , ("M-f",               raiseMaybe (runInTerm "ranger" "ranger" ) (resource =? "ranger"))
        ...
        , ("M-w",               runOrRaise "firefox-developer" (resource =? "Navigator"))
        , ("M-C-f",             runOrRaise "thunar" (resource =? "thunar"))
        , ("M-C-<Return>",      runOrRaise "trayerd" (resource =? "trayer"))
        , ("M-M1-f",            runOrCopy "urxvt -e ranger -e ranger" (resource =? "ranger"))
        , ("M-M1-t",            runOrCopy "urxvt -e newsbeuter -e newsbeuter" (resource =? "newsbeuter"))
        , ("M-M1-m",            runOrCopy "urxvt -e mutt -e mutt" (resource =? "mutt"))
        , ("M-M1-v",            runOrCopy "urxvt -e weechat -e weechat-curses" (resource =? "weechat"))
        , ("M-M1-o",            runOrCopy "urxvt -e htop -e htop" (resource =? "htop"))
...
---STATUSBAR
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
myBitmapsDir = "/home/clement/.dzen/"
myXmonadBarL = "dzen2 -x '0' -y '0' -h '16' -w '680' -ta 'l' -fg '"++myColorWhite++"' -bg '"++myColorBG++"' -fn '"++myFont++"'" 
myXmonadBarR = "conky -c /home/clement/.xmonad/.conky_dzen | dzen2 -x '680' -y '0' -w '1000' -h '16' -ta 'r' -bg '"++myColorBG++"' -fg '"++myColorWhite++"' -fn '"++myFont++"'"
...
myLogHook h  = dynamicLogWithPP $ defaultPP
      ...
      , ppLayout           = dzenColor myColorRed myColorBG  .
                             (\x -> case x of
                                 "oneBig"       -> "   ^i("++myBitmapsDir++"/term.xbm)"
                                 "space"        -> "   ^i("++myBitmapsDir++"/fox.xbm)"
                                 "lined"        -> "   ^i("++myBitmapsDir++"/fox.xbm)"
                                 "monocle"      -> "   ^i("++myBitmapsDir++"/fox.xbm)"
                                 "grid"         -> "   ^i("++myBitmapsDir++"/arch.xbm)"
                                 "float"        -> "   ^i("++myBitmapsDir++"/cat.xbm)"
                                 "gimp"         -> "   ^i("++myBitmapsDir++"/fox.xbm)"
                                 "Full"         -> "   ^i("++myBitmapsDir++"code.xbm)"
                                 _              -> x
                             )
...
myStartupHook = do
          ...
          spawnOnce "hsetroot -fill /home/clement/Documents/Pictures/Wallpapers/magdeleine/12f0a18c.jpeg"
